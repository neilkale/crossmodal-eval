...
def parse_args():
    ...
    parser.add_argument("--model_path", type=str, default='Qwen/Qwen2.5-VL-7B-Instruct', help="select the model path")
    parser.add_argument("--weight_ensembling_ratio", type=float, default=1, help="select the model weight ensembling ratio")
